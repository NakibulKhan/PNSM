...
3. Mobile client documentation and implementation: [P/mobile-client/README.md](../../P/mobile-client/README.md), [checkinService.js](../../P/mobile-client/src/lib/checkinService.js), [compression.js](../../P/mobile-client/src/lib/compression.js), and [liveness.js](../../P/mobile-client/src/lib/liveness.js).
4. Web dashboard documentation and implementation: [S/web-dashboard/README.md](../../S/web-dashboard/README.md), [routes.tsx](../../S/web-dashboard/src/router/routes.tsx), [http.ts](../../S/web-dashboard/src/api/http.ts), and [socket.ts](../../S/web-dashboard/src/lib/socket.ts).
5. Backend implementation: [P/backend-api/src/app.ts](../../P/backend-api/src/app.ts), [attendanceService.ts](../../P/backend-api/src/services/attendanceService.ts), [geofenceService.ts](../../P/backend-api/src/services/geofenceService.ts), [jwt.ts](../../P/backend-api/src/utils/jwt.ts), and [seed.ts](../../P/backend-api/src/scripts/seed.ts).
6. AI service documentation: [M/ai-service/README.md](../../M/ai-service/README.md), [docs/API.md](../../M/ai-service/docs/API.md), [docs/INTEGRATION.md](../../M/ai-service/docs/INTEGRATION.md), [docs/CALIBRATION.md](../../M/ai-service/docs/CALIBRATION.md), [docs/SECURITY.md](../../M/ai-service/docs/SECURITY.md), and [docs/AWS.md](../../M/ai-service/docs/AWS.md).
7. AI service implementation: [app/main.py](../../M/ai-service/app/main.py), [app/ai/engine.py](../../M/ai-service/app/ai/engine.py), [app/ai/score.py](../../M/ai-service/app/ai/score.py), [app/crypto/fle.py](../../M/ai-service/app/crypto/fle.py), and [app/services/verify.py](../../M/ai-service/app/services/verify.py).
8. PNSM test evidence: [P/mobile-client/__tests__](../../P/mobile-client/__tests__), [S/web-dashboard/src/tests](../../S/web-dashboard/src/tests), [P/backend-api/tests](../../P/backend-api/tests), and [M/ai-service/tests](../../M/ai-service/tests).
...
10. OpenCV documentation, *Face Detection using YuNet*, consulted through the implementation choice recorded in `M/ai-service/docs/DECISIONS.md`.
11. MongoDB documentation, *Geospatial Queries and 2dsphere Indexes*, reflected in the backend geofence implementation.
12. OWASP guidance on broken access control, security misconfiguration, and software supply-chain risk, applied and documented in [M/ai-service/docs/OWASP.md](../../M/ai-service/docs/OWASP.md).
